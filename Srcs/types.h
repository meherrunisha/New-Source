...
enum Value : int {
  ...
  PawnValueMg   = 198,   PawnValueEg   = 270,
  KnightValueMg = 815,   KnightValueEg = 915,
  BishopValueMg = 850,   BishopValueEg = 930,
  RookValueMg   = 1200,  RookValueEg   = 1400,
  QueenValueMg  = 2420,  QueenValueEg  = 2700,

  MidgameLimit  = 15200, EndgameLimit  = 4050
};
